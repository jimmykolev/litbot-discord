...
const TOKEN = "MzUwNTQ5NjIyNzYwMTQ0OTAw.DIFqVQ.Bm9p_N1SnZdh69awfeRezjdLno8";
const PREFIX = "-";
...
bot.on("guildMemberAdd", function(member) {
       message.guild.channels.find("name", "general").sendMessage(member.toString() + "Welcome to the server!");
});
...
bot.on("message", function(message) {
    ...
    switch (args[0].toLowerCase()) {
      ...
      case "ping":
         ...
         break;
      case "litball":
         if (args[1]) message.channel.sendMessage(message.author.toString() + litball[Math.floor(Math.random() * litball.length)]);
         else message.channel.sendMessage("Usage: -litball <message>");
         break;
      case "info":
         ...
         .setThumbnail("http://i.imgur.com/TOsEDXB.png")
         .setFooter("A custom bot!")
         .setTimestamp()
      ...
      case "help":
         ...
         .addField("-litball", "Basically 8ball!", true)
         ...
         .setThumbnail("http://i.imgur.com/TOsEDXB.png", true)
         .setFooter("A custom bot!")
         .setTimestamp()
    ...
    case "meme":
         ...
         .setFooter("A custom bot!", "http://i.imgur.com/TOsEDXB.png")
         .setTimestamp()
    ...
    case "suggestion":
         ...
         break;
    case "purge":
      if(!message.member.roles.some(r=>["Director", "Moderator"].includes(r.name)) )
